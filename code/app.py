...
TOOLS = [
    {
        "name": "optimize",
        "description": "Triggers model optimization using Optuna tuning to improve R2 above 0.1, adjust max_depth/num_leaves with regularization, increase directional accuracy above 0.6, engineer sign/log-return lags and momentum filters, increase correlation magnitude above 0.25, stabilize predictions via smoothing or ensembling, and returns results.",
        "parameters": {}
    },
    {
        "name": "write_code",
